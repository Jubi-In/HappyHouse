...
<!--                 <input type="hidden" name="act" id="act" value="register"> -->
			...
			<input type="hidden" id="user_address", name="user_address">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="user_name" name="user_name" placeholder="이름입력...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="user_pw" name="user_pw" placeholder="비밀번호입력...">
                </div>
                <div class="form-group">
